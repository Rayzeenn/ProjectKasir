        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button type="button" class="btn btn-info col-xl-2a mb-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Tambah Pesanan Baru
                    </button>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-danger col-xl-3" data-bs-toggle="modal" data-bs-target="#delete<?= $idpesanan; ?>">
                                                    Selesai
                                            </button></td>
                                        </tr>
